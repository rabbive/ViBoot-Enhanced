	...
	for (let j = 0; j < tables.length; j++) {
		...
		if (
			...
			if (tot_weightage_equi >= 34) {
                ...
                <tr class="tableContent-level1" style='background: rgb(170, 255, 0,0.6);'>
                    <td colspan="${colspan}" style="text-align:center">You need only ${pass_marks} marks out of 100 in FAT to pass this course. 🥳</td>
                </tr>
                `;
			} else {
                ...
                <tr class="tableContent-level1" style='background: rgb(255,0,0,0.6);'>
                    <td colspan="${colspan}" style="text-align:center"><b>Minimum ${pass_marks.toFixed(2)} marks are required in FAT to pass this course.<b></td>
                </tr>
                `;
			}
		}
		...
		// Labs
			...
			if (tot_weightage_equi >= 50) {
				pass_marks =
					'You have fulfilled the criteria of passing this lab course. 🥳';
				tables[j].innerHTML += `
                <tr class="tableContent-level1" style='background: rgb(170, 255, 0,0.6);'>
		...
		// STS
			...
			if (tot_weightage_equi >= 50) {
				pass_marks =
					'You have fulfilled the criteria of passing this STS course. 🥳';
				tables[j].innerHTML += `
                <tr class="tableContent-level1" style='background: rgb(170, 255, 0,0.6);'>
                    <td colspan="${colspan}" style="text-align:center">${pass_marks}</td>
                </tr>
